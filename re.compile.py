...
item='https://nc.fang.anjuke.com/loupan/430416.html'
pat1 = "(https://.*?/.*?/).*?html"
pat2 = 'https://.*?/.*?/(.*?html)'
newurl = re.compile(pat1).findall(item)[0] + "canshu-" + re.compile(pat2).findall(item)[0] + "?from=loupan_tab"
...
# print(picid)
# print(starttime1)
# print(starttime1[0].replace(' ','').replace('\n',''))
# print(givetime1)
'''
