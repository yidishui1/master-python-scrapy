...
def craw(url,page):
    ...
    html1 = str(html1)
    pat1 = '<ul class="gl-warp clearfix">.+? <div class="page clearfix">'#第一道过滤
    result1 = re.compile(pat1).findall(html1)
    result1 = result1[0]
    #print(result1)
    pat2 = '<img width="220" height="220".+?\.jpg'#初步提取图片code
    imagelist = re.compile(pat2).findall(result1)
    x=1
    for imageurl in imagelist:
        imagename = "C:/Users/leishen/Documents/anaconda3/scrapy/master python scrapy/chapter 6/img1/"+str(page)+"-"+str(x)+".jpg"
        '''过滤出图片代码'''
        pat3 = '//(.+?\.jpg)' #精确提取图片code
